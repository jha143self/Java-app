...
@Configuration
@ComponentScan(basePackages = { "com.user.application.config" })
...
//    	
        ...
        // @formatter:off
		  ...
		  http .csrf().disable() .authorizeRequests() .antMatchers("/login*","/login*",
		  "/logout*", "/signin/**", "/signup/**", "/customLogin",
		  ...
		  .anyRequest().hasAuthority("READ_PRIVILEGE") .and() .formLogin()
		  .loginPage("/login") .defaultSuccessUrl("/homepage.html")
		  .failureUrl("/login?error=true");
//		  .successHandler(myAuthenticationSuccessHandler)
//		  .failureHandler(authenticationFailureHandler) //
//		  .authenticationDetailsSource(authenticationDetailsSource) .permitAll() .and()
